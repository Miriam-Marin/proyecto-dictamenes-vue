<template>
  <!-- ===================== ACCIONES Modulo ReceplabResultadosModulo ===================== -->
  ...
  <section class="modulo-contenido" ref="moduloContenidoRef">
    ...
    <div v-if="selectedAction === 'registrar'">
      ...
      <div class="sistpec-search-bar">
        ...
        <!-- BOTONES A LA DERECHA (vertical + un poco abajo) -->
          ...
          <tbody>
            <tr v-for="r in resultadosConsulta" :key="'c-' + r.id">
              ...
              <td>
                <span
                  class="badge"
                  :class="r.estado === 'Pendiente' ? 'badge--proceso' : 'badge--activo'"
                >
                  {{ r.estado }}
                </span>
              </td>
    ...
    <div v-else-if="selectedAction === 'editar'">
      ...
      <div v-if="resultadosEditar.length" class="sistpec-table-wrapper">
          ...
          <tbody>
            ...
            <tr v-if="resultadosEditar.length === 0">
              <td colspan="10" class="sin-resultados">
                No hay resultados pendientes con esos criterios.
              </td>
            </tr>
          </tbody>
        </table>
        ...
        <small class="ayuda">
          Solo se permite editar cuando el estado es <strong>Pendiente</strong>. Si está
          <strong>Entregado</strong>, ya no se puede editar.
        </small>
      </div>
    ...
    <div v-else-if="selectedAction === 'eliminar'">
      ...
      <div v-if="resultadosEliminar.length" class="sistpec-table-wrapper">
        ...
        <small class="ayuda">
          El sistema solo permite eliminar si el resultado está <strong>Pendiente</strong>.
        </small>
      </div>
